...
local Founder = {"steam:1100001153f8668", "ip:127.0.0.1"}
local ChiefAdmin = {"steam:110000131e96753", "ip:"}
local Admin = {"steam:110000109902fac", "ip:"}
local Fire = {"steam:", "ip:"}
local EMT = {"steam:", "ip:"}
local Sheriff = {"steam:", "ip:"}
local Moderator = {"steam:", "ip:"}
local HP = {"steam:110000134541e9c", "ip:"}
local PD = {"steam:", "ip:"}
local Test = {"steam:", "ip:"}
...
AddEventHandler(
    ...
    function(source, name, message)
        ...
        if string.find(args[1], "/") then
            ...
            elseif has_value(ChiefAdmin, player) then
                TriggerClientEvent("chatMessage", -1, "Community Manager | " .. name, {36, 127, 50}, message)
            elseif has_value(Fire, player) then
            ...
            elseif has_value(HP, player) then
                TriggerClientEvent("chatMessage", -1, "FHP | Senior Trooper " .. name, {222, 0, 255}, message)
            elseif has_value(Test, player) then
