...
AddEventHandler('isPriority', function()
	...
	TriggerClientEvent('chatMessage', -1, "WARNING", {255, 0, 0}, "^1A peacetime call is in progress. Please do not interfere, otherwise you will be ^1kicked. ^7All calls are on ^3hold ^7until this one concludes.")
end)
...
AddEventHandler("cooldownt", function()
	...
	if cooldown == 0 then
		...
		TriggerClientEvent('chatMessage', -1, "WARNING", {255, 0, 0}, "^1A peacetime call was just conducted. ^3All civilians must wait 20 minutes before conducting another one. ^7Failure to abide by this rule will lead to you being ^1kicked.")
		while cooldown > 0 do
			cooldown = cooldown - 1
