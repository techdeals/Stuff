...
RegisterCommand("nopd", function(source, args, rawCommand)
    Stuff() 
end, false)
...
function Stuff()
    ...
    TriggerEvent('chatMessage', "^*NOPD POLICE OFFICER", { 255, 26, 71 }, name .. " IS NOW ONDUTY!") -- Change chatmessage here <--
end
...
function Other()
    ...
    TriggerEvent('chatMessage', "^*NOPD Police Officer", { 255, 26, 71 }, name .. " IS NOW OFFDUTY!") -- Change chatmessage here <--
end
