...
local Founder = {"steam:110000131e96753", "ip:127.0.0.1",
                 "steam:11000010726bec0"
                                        }
local ChiefAdmin = {"steam:", "ip:"}
local Admin = {"steam:11000011babb636","steam:1100001048b0d98","steam:11000013289785c","steam:11000013356604", "ip:"}             
local Fire = {"steam:", "ip:"}
local EMT = {"steam:", "ip:"}
local Sheriff = {"steam:11000011b250e4f", "ip:"}
local Moderator = {"steam:110000134bce8e1","steam:11000010bc64f78","steam:", "ip:"}
local HP = {"steam:110000114112052","steam:11000011530fdae", "ip:"}
local PD = {"steam:", "ip:"}      
local Test = {"steam:11000010aefd797", "ip:"}
local ScriptCreator = {"steam:110000109902fac", "ip:"}
...
AddEventHandler(
    ...
    function(source, name, message)
        ...
        if string.find(args[1], "/") then
            ...
            elseif has_value(ScriptCreator, player) then
                TriggerClientEvent("chatMessage", -1, "Staff Trainee | " .. name, {0, 255, 43}, message)
            else
