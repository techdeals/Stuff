...
RegisterCommand("gangcop", function(source, args, rawCommand)
    Stuff() 
end, false)


function Stuff()
    local model = GetHashKey("gangcop") -- Change model name here <--
    RequestModel(model)
    ...
    TriggerEvent('chatMessage', "^*Gang Unit Officer", { 255, 26, 71 }, name .. " IS NOW ONDUTY!") -- Change chatmessage here <--
end
...
function Other()
    ...
    TriggerEvent('chatMessage', "^*Gang Unit Officer", { 255, 26, 71 }, name .. " IS NOW OFFDUTY!") -- Change chatmessage here <--
end
