...
function lspdskin()
    Citizen.CreateThread(function()
	   ...
	   drawNotification("You have put on you NOPD uniform.")
...
function bcsoskin()
    Citizen.CreateThread(function()
        ...
        if HasModelLoaded(copModel) then
	   drawNotification("You have put on you Sheriff uniform.")
            SetPlayerModel(PlayerId(), copModel)
        else
	   drawNotification("The model could not load - if you see this contact development.")
        end
...
function sahpskin()
    Citizen.CreateThread(function()
        ...
        if HasModelLoaded(copModel) then
	   drawNotification("You have put on you LSP uniform.")
            SetPlayerModel(PlayerId(), copModel)
        else
	   drawNotification("The model could not load - if you see this contact development.")
        end
...
function lafdskin2()
    Citizen.CreateThread(function()
        ...
        if HasModelLoaded(copModel) then
	   drawNotification("You have put on your Fire Department Medic uniform.")
            SetPlayerModel(PlayerId(), copModel)
        else
	   drawNotification("The model could not load - if you see this contact development.")
        end
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_LS_TOURIST_BOARD", "CHAR_LS_TOURIST_BOARD", true, 1, "~y~Louisiana State Traffic Info~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_LS_CUSTOMS", "CHAR_LS_CUSTOMS", true, 1, "~y~New Orleans Customs~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "BELL", true, 1, "~y~Taco Bell~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "NA", true, 1, "~y~Domino's Pizza~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_MP_MORS_MUTUAL", "CHAR_MP_MORS_MUTUAL", true, 1, "~y~Geico~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "OP", true, 1, "~y~FedEx~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "EXOTIC", true, 1, "~y~West Coast Customs~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "LSWP", true, 1, "~y~American Water and Power~s~", "");
DrawNotification(false, true);
...
SetNotificationTextEntry("STRING");
AddTextComponentString(inputText);
SetNotificationMessage("CHAR_FLOYD", "D8", true, 1, "~y~Remax~s~", "");
DrawNotification(false, true);
