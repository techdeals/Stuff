...
AddEventHandler("JP", function(jT)
	...
	if DoesEntityExist(pP) then
		...
		Citizen.CreateThread(function()
			...
			SetEntityCoords(pP, 1838.01, 3683.46, -118.76)                  --1677.233, 2658.618, 45.216) 
			cJ = true
			eJE = false
			while jT > 0 and not eJE do
				...
				local D = Vdist(1838.01, 3683.46, -118.76, pL['x'], pL['y'], pL['z'])
				if D > 90 then
					SetEntityCoords(pP, 1838.01, 3683.46, -118.76)
					if D > 100 then
						jT = jT + 60
						if jT > 1500 then
							jT = 1500
