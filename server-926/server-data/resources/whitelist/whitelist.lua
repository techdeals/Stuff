...
AddEventHandler("playerConnecting", function(playerName, setKickReason, deferrals)
    ...
    for myIdx,identifier in pairs(GetPlayerIdentifiers(s)) do
        ...
        for wIdx,i in ipairs(whitelistArray) do
			...
			deferrals.update(string.format("Checking LossRP | Whitelist: %.2f%%", (currentId / totalChecksNeeded)*100))
	...
	deferrals.done("You are not a LossRP | Whitelisted member. Join our discord to find out how to be one. discord.gg/9VzpVtd ")
end)
